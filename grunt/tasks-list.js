...
module.exports = function tasks(grunt) {
    ...
    grunt.registerTask('build:all', ['build:allBrands', 'default-brand', 'copy:dashboardPages',
        'browserifyImports', 'scripts', 'styles', 'build:dashboard', 'connect', 'open', 'watch:app']); //'karma:unit',
    ...
    grunt.registerTask('build:dist',[
      'clean:dist', 'browserifyImports', 'jshint:components', 'browserify:appForProd', 'lessImportsModules','build:allBrands',
        'copy:prodAssets', 'copy:prodAppBuild', 'disableDebugInProd','textReplace:replace',
    'uglify:app', 'cssmin:app', 'fileReplace:rename', 'karma:unit']);
    ...
    grunt.registerTask('default-brand', ['browserifyImports', 'scripts','brandSwitch:' + grunt.const.defaultBrand, 'brandAssets:' + grunt.const.defaultBrand]);
    ...
    grunt.registerTask('watch:all', ['build:allBrands', 'copy:dashboardPages', 'browserifyImports', 'scripts', 'dashboard', 'connect', 'open',  'watch:brands']);
